...
@CucumberOptions(
		features = "Features/CompareUI.feature", tags={"@Compare50RevMatFord"}, glue= {"com/wiz/materialCenter/stepDefinition"}, plugin = { "pretty", "json:target/cucumber-reports/cucumber.json", 
