...
@CucumberOptions(
		features = "Features/CompareUI.feature", tags={"@ConfigNav"}, glue= {"com/wiz/materialCenter/stepDefinition"}, plugin = { "pretty", "json:target/cucumber-reports/cucumber.json", 
